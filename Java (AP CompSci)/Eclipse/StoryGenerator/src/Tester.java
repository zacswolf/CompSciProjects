...
public class Tester {
	...
	private static String OnceorMultiple;
	private static ArrayList<Character> usuableCharslist = new ArrayList<Character> ();
	
	//constructor allows you the initialize variables as soon as a object is created
	public void Creator(String Type, int length, Boolean Rules, String cType1){
		OnceorMultiple = Type;
		numOfTypes = 1;
		String[] numType = new String[numOfTypes];
		numType[0] = cType1;
	}
	public void Creator(String Type, int length, Boolean Rules, String cType1, String cType2){
		OnceorMultiple = Type;
		numOfTypes = 2;
		String[] numType = new String[numOfTypes];
		numType[0] = cType1;
	...
	public void Creator(String Type, int length, Boolean Rules, String cType1, String cType2, String cType3){
		OnceorMultiple = Type;
		numOfTypes = 3;
		String[] numType = new String[numOfTypes];
		numType[0] = cType1;
	...
	public void Creator(String Type, int length, Boolean Rules, String cType1, String cType2, String cType3, String cType4){
		OnceorMultiple = Type;
		numOfTypes = 4;
		String[] numType = new String[numOfTypes];
		numType[0] = cType1;
	...
	public void Creator(String Type, int length, Boolean Rules, String cType1, String cType2, String cType3, String cType4, String cType5){
		OnceorMultiple = Type;
		numOfTypes = 5;
		String[] numType = new String[numOfTypes];
		numType[0] = cType1;
	...
	public void Creator(String Type, int length, Boolean Rules, String cType1, String cType2, String cType3, String cType4, String cType5, String cType6){
		OnceorMultiple = Type;
		numOfTypes = 5;
		String[] numType = new String[numOfTypes];
		numType[0] = cType1;
