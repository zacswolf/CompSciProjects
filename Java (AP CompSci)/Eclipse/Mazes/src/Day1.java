...
public class Day1 extends Canvas implements Runnable{
	...
	public static String NAME = "Day1";
	...
	private BufferedImage image = new BufferedImage(WIDTH, HEIGHT, BufferedImage.TYPE_INT_RGB);//we draw this image in render
	private int[] pixels = ((DataBufferInt) image.getRaster().getDataBuffer()).getData(); //Pixels Variable
